 ...
 * 유사문제 : 벽부수고이동하기
 * 다른 풀이: 말처럼 뛸 수 있는 경우에는 원숭이처럼 뛰는 경우도 포함이므로 반복문 for()에서 반복횟수에 삼항연산자를 통해 한번에 처리가 가능할 수 있다.
 * 					반복문의 횟수 조건에 삼항연산자를 쓸 수 있다는 점을 기억하자
 * 					k를 주는것도 마찬가지로 변수 d값을 통해서 삼항연산자를 통해 할 수 있다~
 * 					삼항연산자의 쓰임 !! 
 */
package solution;
